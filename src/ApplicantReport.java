...
public class ApplicantReport {
	...
	public Scene getApplicantReport() throws ClassNotFoundException, SQLException {
	...
	private StackPane getTop() {
		...
		Text text = new Text("Applicant Report");
	...
	public ObservableList<String> getList() throws ClassNotFoundException, SQLException{
		...
		for(int i = 0; i<array.length; i++) {
			...
			array [i] = String.format("%28s %35s %32s %28s %20s %20s", rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5),  rs.getString(7));

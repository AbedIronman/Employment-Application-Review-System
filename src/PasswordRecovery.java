...
public class PasswordRecovery {
	...
	private VBox getCenter() {
		...
		questions.setOnMouseEntered(new EventHandler<MouseEvent>() {
			@Override
		...
		questions.setOnMouseExited(new EventHandler<MouseEvent>() {
			@Override
			public void handle(MouseEvent event) {
		...
		recover.setOnMouseEntered(new EventHandler<MouseEvent>() {
			@Override
			public void handle(MouseEvent event) {
				borderPane.setCursor(Cursor.HAND);
			}
		...
		recover.setOnMouseExited(new EventHandler<MouseEvent>() {
			@Override
			public void handle(MouseEvent event) {
				borderPane.setCursor(Cursor.DEFAULT);
			}
	...
	private void signUp(TextField lname, TextField userid,
		...
		if(lastname.equals(lname.getText())) {
			...
			if(question.equals(que.getValue()) && answer.equals(ans.getText())) {
				Alert alert = new Alert(AlertType.INFORMATION, "Password Recovery Successfull!", ButtonType.CLOSE);
				alert.showAndWait();
				...
				Alert alert = new Alert(AlertType.INFORMATION, "Incorrect Details entered. Try again!", ButtonType.CLOSE);
				alert.showAndWait();
			}
		}
	}
